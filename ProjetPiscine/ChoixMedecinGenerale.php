        ...
        <div id="wrapper">
            ...
            <div id="section">
                <div id="tableau">
                    ...
                    var Medecins='<table><tr><td><h2>Médecins Généralistes:</h2></td></tr>';
                    for(var i=0; i<Nom.length; i++){
                        Medecins += '<tr><td><button id="btn_Nom_Medecin" style="width:100%" value="'+Nom[i]+'">'+Nom[i]+" "+Prenom[i]+'</button></td></tr>';
                    }
                    Medecins +='</table>';
